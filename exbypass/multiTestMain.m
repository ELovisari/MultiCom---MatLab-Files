...
smatrix = t;
for iEdge = 1:M
smatrix = [smatrix squeeze(aafRho(1,iEdge,t)) squeeze(aafRho(2,iEdge,t))];
end
save rho.dat smatrix -ascii 

smatrix = t;
for iEdge = 1:M
smatrix = [smatrix squeeze(aafFlow(1,iEdge,t)) squeeze(aafFlow(2,iEdge,t))];
end
